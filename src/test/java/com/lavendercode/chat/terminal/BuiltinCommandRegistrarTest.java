...
class BuiltinCommandRegistrarTest {
    ...
    @Test
    void returnsFifteenCommandDefinitions() {
    ...
    void allNamesMatchExpectedSet() {
        ...
        assertThat(names).containsExactlyInAnyOrder(
            ...
            "permission", "plan", "resume", "review", "session", "status", "worktree", "team"
        );
    }
    ...
    @Test
    void localCommandsAreStatusMemoryPermissionSessionHelpWorktreeTeam() {
        var defs = BuiltinCommandRegistrar.builtinCommands();
        ...
        assertThat(localNames).containsExactlyInAnyOrder(
            "help", "hooks", "memory", "permission", "session", "status", "worktree", "team"
        );
    }
    ...
    void canConstructRegistryWithoutConflict() {
        ...
        assertThat(registry.visibleCommands()).hasSize(15);
    }
